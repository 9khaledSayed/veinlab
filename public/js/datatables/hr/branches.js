            ...
            columns: [
                {
                    ...
                    template: function(data) {
                        return '\
                            <a  href="/dashboard/hr/branches/' + data.id + '/edit"   style="background:transparent;border:0px" class="show"><i class="fa fa-file-alt"></i><br>' + locator.__('edit') + '</a>\
                        ';
                    },
                }],
        });
