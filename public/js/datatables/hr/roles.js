                        ...
                        return '\
                          <div class="dropdown">\
                              ...
                              <div class="dropdown-menu dropdown-menu-right">\
                                  <a class="dropdown-item" href="/dashboard/hr/roles/' + row.id + '/edit"><i class="la la-leaf"></i>' + locator.__('Edit') + '</a>\
                                  <a class="dropdown-item" href="/dashboard/hr/roles/' + row.id + '"><i class="la la-leaf"></i>' + locator.__('Show') + '</a>\
