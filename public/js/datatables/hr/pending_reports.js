...
var KTDatatableLocalSortDemo = function() {
    ...
    var messages = {
        'ar': {
            'Report Date': "تاريخ مسير الرواتب",
            ...
            columns: [
                {
                    ...
                    textAlign: 'center',
                    template:function(row){
                        return '<span class="kt-font-success">' + row.total_additions + '</span>';
                    }
                }, {
                        ...
                        return  '\
                                  <div class="dropdown">\
                                      ...
                                      <div class="dropdown-menu dropdown-menu-right">\
                                          <a class="dropdown-item" href="/dashboard/hr/salary_reports/' + row.id + '/approve"><i class="la la-check kt-font-success"></i>' + locator.__('Approve') + '</a>\
                                          <a class="dropdown-item" href="/dashboard/hr/salary_reports/' + row.id + '/reject">' + '<i class="la la-times kt-font-reject"></i>' + locator.__('Reject') + '</a>\
                                          <a class="dropdown-item" href="/dashboard/hr/salary_reports/' + row.id + '/cancel"><i class="la la-ban kt-font-danger"></i>' + locator.__('Cancel') + '</a>\
                                      </div>\
                                  </div>\
		                    ';
