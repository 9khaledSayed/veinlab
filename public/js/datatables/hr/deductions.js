...
var KTUserListDatatable = function() {
    ...
    var messages = {
        'ar': {
            ...
            'Amount' : 'المبلغ',
            'Print Alert' : 'طباعة اﻹنذار الكتابي',
            'Status' : 'الحالة',
            'Details' : 'تفاصيل',
            'Approved' : 'معتمد',
            'Cancelled' : 'ملغي',
            ...
            'Cancel':"الغاء",
            'Close':"اغلاق",
            'Are you sure to Approve this deduction?':"متاكد من اعتماد هذا الحسم ؟",
            'Are you sure to Cancel this deduction?':"متاكد من الغاء هذا الحسم ؟",
        ...
        datatable = $('#kt_apps_user_list_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function(row) {
                    ...
                    return '<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill">' + locator.__(row.reason) + '</span>';
                },
            }, {
                field: 'amount',
                ...
                template: function(row) {
                                                        ...
                                                        <div class="kt-section kt-section--first">\
                                                            <div class="kt-section__body">\
                                                                <div class="form-group row">\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Employee Number') + ':</label>\
                                                                    <div class="col-lg-3">\
                                                                        <p class="form-control border-0 m-0">' + employee.emp_num + '</p>\
                                                                    </div>\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Operation Date') + ':</label>\
                                                                    <div class="col-lg-3">\
                                                                        <p class="form-control border-0 m-0">' + row.operational_date + '</p>\
                                                                    </div>\
                                                                </div>\
                                                                <div class="form-group row">\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Employee') + ':</label>\
                                                                    <div class="col-lg-3">\
                                                                        <p class="form-control border-0 m-0">' + employee.fname_arabic + ' ' + employee.lname_arabic +  '</p>\
                                                                    </div>\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Effective Date') + ':</label>\
                                                                    <div class="col-lg-3">\
                                                                        <p class="form-control border-0 m-0">' + row.effective_date + '</p>\
                                                                    </div>\
                                                                </div>\
                                                                <div class="form-group row">\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Amount') + ':</label>\
                                                                    <div class="col-lg-3">\
                                                                        <p class="form-control border-0 m-0">' + row.amount + '</p>\
                                                                    </div>\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Status') + ':</label>\
                                                                    <div class="col-lg-3">\
                                                                        <p class="form-control border-0 m-0 ' + status[row.status].class + '">' + status[row.status].title + '</p>\
                                                                    </div>\
                                                                </div>\
                                                                <div class="form-group row">\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Notes') + ':</label>\
                                                                    <div class="col-lg-6">\
                                                                        <p class="form-control border-0 m-0"> ' + row.notes + '</p>\
                                                                    </div>\
                                                                </div>\
                                                            </div>\
                                                            <div class="kt-section__body">\
                                                                <div class="form-group row">\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Created Date') + ':</label>\
                                                                    <div class="col-lg-3">\
                                                                        <p class="form-control border-0 m-0">' + row.created_at + '</p>\
                                                                    </div>\
                                                                    <label class="col-lg-3 col-form-label">' + locator.__('Modified Date') + ':</label>\
                                                                    <div class="col-lg-3">\
                    ...
                    <div class="dropdown">\
                              ...
                              <div class="dropdown-menu dropdown-menu-right">\
                                      <a class="dropdown-item" href="/dashboard/hr/alert_letter/' + row.id + '"><i class="la la-leaf"></i>' + locator.__('Print Alert') + '</a>\
                                  <a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_' + row.id + '"><i class="la la-leaf"></i>' + locator.__('Details') + '</a>\
                              </div>\
                          </div>\
						';
                },
