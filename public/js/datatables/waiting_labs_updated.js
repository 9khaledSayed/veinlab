            ...
            columns: [
                {
                    ...
                    template: function(raw) {
                        if(raw.result == 2)
                        return '<a class="h5 kt-font-success" href="/dashboard/waiting_labs/' + raw.id + '/edit"><i class="flaticon-reply"></i>' + locator.__('Hide') + '</a>';
                        return '<a class="h5 kt-font-danger" href="/dashboard/waiting_labs/' + raw.id + '/edit"><i class="flaticon-reply"></i>' + locator.__('Hide') + '</a>';
                    },
                }, {
                    field: 'created_at',
                    ...
                    template: function(row) {
                        ...
                        ';
		                  ...
		                  <div class="dropdown">\
		                      ...
		                      <div class="dropdown-menu dropdown-menu-right">\
		                          <a class="dropdown-item" href="/dashboard/results/create?waiting_lab_id=' + row.id   + '"><i class="la la-edit"></i>' + locator.__('Create Result') + '</a>\
		                      </div>\
		                  </div>\
		              ';
                        }
