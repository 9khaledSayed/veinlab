...
var KTContactsAdd = function () {
    ...
    let messages = {
        'ar': {
            ...
            "Choose":"اختر",
            "Cannot add / modify operations to an already issued payroll":"لايمكن اضافة عمليات علي مسير رواتب تم اعتماده",
            "you must reissue Salary report to see operations":"يجب عليك إعادة اصدار مسير الرواتب لرؤية هذه العملية",
        }
    };
    ...
    var initSubmit = function() {
        ...
        var close1 = formEl1.find('[data-dismiss="modal"]');
                ...
                formEl1.ajaxSubmit({
                    success: function(response) {
                        ...
                        if(response.message == 2){
                            swal.fire({
                                "title": "",
                                "text": locator.__('Cannot add / modify operations to an already issued payroll'),
                                "type": "error",
        ...
        if($(this).val() != ''){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    switch (data.status){
                        case 2 :
                            message2.text(locator.__("Cannot add / modify operations to an already issued payroll"));
                            message1.text("");
                            break;

                        case 1 :
                            message1.text(locator.__("you must reissue Salary report to see operations"));
                            message2.text("");
                            break;
                        case 3 :
                            message1.text(locator.__("you must reissue Salary report to see operations"));
