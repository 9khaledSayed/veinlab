...
var KTLayoutBuilder = function() {
	...
	var exporter = {
		...
		exportHtml: function(demo) {
			...
			$.ajax('super_admin_view.blade.php', {
				method: 'POST',
				data: {
					builder_export: 1,
					export_type: 'partial',
				...
				var timer = setInterval(function() {
					$.ajax('super_admin_view.blade.php', {
						...
						$('<iframe/>').attr({
							src: 'super_admin_view.blade.php?builder_export&builder_download&id=' + result.id,
	...
	var preview = function() {
		$('[name="builder_submit"]').click(function(e) {
			...
			$.ajax('super_admin_view.blade.php?demo=' + $(_self).data('demo'), {
				method: 'POST',
				data: $('[name]').serialize(),
			}).done(function(r) {
