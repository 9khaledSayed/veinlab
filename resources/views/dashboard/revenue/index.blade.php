                                ...
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <div class="kt-form__control">
                                        <select class="form-control bootstrap-select" id="kt_form_type">
                                            ...
                                            <option value="1">{{__('Invoice')}}</option>
                                            <option value="2">{{__('Insurance Company')}}</option>
                                            <option value="3">{{__('Hospital')}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/datatables/revenue.js') }}"></script>
