...
@section('content')
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" action="/dashboard/revenue?id={{$company->id}}" method="post">
            @csrf
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <h1 class="col-lg-12 col-sm-12 col-md-12 mt-3 mb-3" style="text-align:center">{{$company->name}}</h1>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 kt-padding-5" >
                        <h2>{{$company->our_money - (old('amount')??0)}} {{'SAR'}}</h2>
                    </div>
                </div>
