...
@section('content')
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="post" action="{{route('dashboard.home_visits.store')}}">
            @method('POST')
            @csrf
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control  @error('address') is-invalid @enderror" type="text" value="{{ old('address') }}" id="example-text-input" name="address">
                        @error('address')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control  @error('phone') is-invalid @enderror" type="text" value="{{ old('phone') }}" id="example-text-input" name="phone">
                        @error('phone')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control  @error('email') is-invalid @enderror" type="email" value="{{ old('email') }}" id="example-text-input" name="email">
                        @error('email')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <select name="sex"
                                ...
                                value="{{old('sex')}}"
                                title="{{__('Choose')}}">
                            <option value="0" @if(old('sex') == "0") selected @endif>{{__('Male')}}</option>
                            <option value="1" @if(old('sex') == "1") selected @endif>{{__('Female')}}</option>
                            <option value="2" @if(old('sex') == "2") selected @endif>{{__('Child')}}</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <div class="input-group date">
                            <input name="dateTime" type="text" class="form-control @error('dateTime') is-invalid @enderror datepicker" value="{{ old('dateTime') }}" readonly/>
