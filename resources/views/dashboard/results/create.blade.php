                ...
                <div class="kt-section">
                    <div class="kt-section__content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @foreach($sub_analyses as $sub)
                                    <tr>
                                        <td style="direction: ltr;width: 20%">{{$sub->name}}</td>
                                        <td style="direction: ltr;width: 20%">
                                            <input type="text"
                                                   dir="ltr"
                                        ...
                                        <td style="width: 20%;direction: ltr">{!! $sub->unit !!}</td>
                                        <td style="direction: ltr;width: 20%">
                        ...
                        @if($main_analysis->has_cultivation)
                            ...
                            <div style="display: none" id="cultivationDiv">
                                ...
                                <input dir="auto" class="form-control text-center @error('cultivation') is-invalid @enderror"
                                       name="cultivation" value="{{old('cultivation')}}"/>
                                @error('cultivation')
                                        ...
                                        <div class="kt_repeater shadow p-3">
                                            ...
                                            <div class="form-group form-group-last row kt_repeater">
                                                <div data-repeater-list="high_sensitive_to" class="col-lg-12">
                                                    @forelse(old('high_sensitive_to') ?? [] as $highSensitiveTo)
                                        ...
                                        <div class="kt_repeater shadow p-3">
                                            ...
                                            <div class="form-group form-group-last row kt_repeater">
                                                <div data-repeater-list="moderate_sensitive_to" class="col-lg-12">
                                                    @forelse(old('moderate_sensitive_to') ?? [] as $moderateSensitiveTo)
                                                        <div data-repeater-item
                                                             class="form-group row align-items-center">
                                                            <div class="col-md-10">
                                                                <div class="kt-form__group--inline">
                                        ...
                                        <div class="kt_repeater shadow p-3">
                                            ...
                                            <div class="form-group form-group-last row kt_repeater">
                                                <div data-repeater-list="resistant_to" class="col-lg-12">
                                                    @forelse(old('resistant_to') ?? [] as $resistantTo)
                                                        <div data-repeater-item
                                                             class="form-group row align-items-center">
                                                            <div class="col-md-10">
                                                                <div class="kt-form__group--inline">
                        ...
                        <div class="form-group row mt-5">
                            <div class="col-lg-12">
                            <textarea id="kt-tinymce-2" placeholder="{{__('Type your notes')}}" dir="rtl" name="lab_notes" class="tox-target">
