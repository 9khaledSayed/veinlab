                    ...
                    <div class="kt-section__content">
                        ...
                        @if($main_analysis->has_cultivation)
                                ...
                                <select class="form-control @error('growth_status') is-invalid @enderror selectpicker"
                                    ...
                                    <option value="no_growth" {{(old('growth_status') ?? $waiting_lab->growth_status) == 'no_growth' ? 'selected' : ''}}>No Growth</option>
                                    <option value="growth" {{(old('growth_status') ?? $waiting_lab->growth_status) == 'growth' ? 'selected' : ''}}>Growth</option>
                                </select>
