        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @can('view_reports')
                    <a href="/export/results" class="btn btn-danger btn-icon-sm ml-2 mr-2">
...
@push('scripts')
    @if(Auth::guard('employee')->check())
        <script src="{{asset('js/datatables/result.js')}}" type="text/javascript"></script>
    @else
        <script src="{{asset('js/datatables/patientHospitalResults.js')}}" type="text/javascript"></script>
    @endif
