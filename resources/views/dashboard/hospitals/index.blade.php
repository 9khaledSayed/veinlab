        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @can('view_reports')
                    <a href="/export/hospitals"  class="btn btn-danger btn-icon-sm ml-2 mr-2">
                        <i class="la la-file-excel-o"></i> {{__('Export')}}
                    </a>
                    @endcan
                    @can('create_hospitals')
                    <a href="{{route('dashboard.hospitals.create')}}" class="btn btn-brand btn-icon-sm">
...
{{--                            </div>--}}
                            <div class="col-md-6 kt-margin-b-20-tablet-and-mobile">
                                <form method="get" action="{{route('dashboard.hospitals.report')}}" id="date_form">
                                    @csrf
                                <div class="kt-form__group kt-form__group--inline">
                                    <div class="kt-form__label">
                                        <label>{{__('Date')}}:</label>
...
@push('scripts')
    ...
    <script src="{{ asset('js/datatables/hospitals.js') }}"></script>
