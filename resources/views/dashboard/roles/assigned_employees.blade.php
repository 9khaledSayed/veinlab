            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        @can('create_roles')
                            <div class="btn-group">
                                <a href="{{route('dashboard.roles.create_assignment')}}" class="btn btn-primary" >
                                    <i class="fa fa-plus"></i>
                                    {{__('Assign Role To Employee')}}
                                </a>
                            </div>
                        @endcan
                    </div>
...
@push('scripts')
    <script src="{{asset('js/datatables/assigned_employees.js')}}" type="text/javascript"></script>
@endpush
