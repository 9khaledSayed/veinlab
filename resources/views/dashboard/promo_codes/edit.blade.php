...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
                <!--begin::Form-->
                <form class="kt-form kt-form--label-right" action="{{route('dashboard.promo_codes.update', $promoCode)}}" method="post">
                    @csrf
                    @method('put')
                    <div class="kt-portlet__body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="kt-radio-inline">
                                        <label class="kt-radio">
                                            <input type="radio" name="type" value="{{config('enums.promoCodeOn.invoice')}}" @if((old('type') ?? $promoCode->type)==config('enums.promoCodeOn.invoice')) checked @endif  > {{__('Invoice')}}
                                            <span></span>
                                        </label>
                                        <label class="kt-radio">
                                            <input type="radio" name="type" value="{{config('enums.promoCodeOn.analysis')}}"  @if((old('type') ?? $promoCode->type) == config('enums.promoCodeOn.analysis')) checked @endif> {{__('Custom Analysis')}}
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                <select class="form-control @error('main_analysis_id')is-invalid @enderror kt-select2"
                                    ...
                                    @forelse($main_analysis as $analysis)
                                        <option
                                            value="{{$analysis->id}}"
                                            @if($analysis->id == (old('main_analysis_id')?? $promoCode->main_analysis_id)) selected @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                <input
                                    ...
                                    value="{{old('percentage') ?? $promoCode->percentage}}"
                                    id="example-text-input">
                                @error('percentage')
                                    <div class="invalid-feedback">
                                        {{$message}}
                            ...
                            <div class="col-lg-6 col-md-9 col-sm-12">
                                <div class='input-group' id='kt_daterangepicker_2'>
                                    <input type="text"
                                           ...
                                           readonly
                                           value="{{old('ranges') ?? ($promoCode->from->format('Y-m-d')  . ' / ' .  $promoCode->to->format('Y-m-d'))}}"
                        ...
                        <div class="kt-form__actions">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a href="{{route('dashboard.promo_codes.index')}}" class="btn btn-secondary">{{__('back')}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
