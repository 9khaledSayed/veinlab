        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                <span class="kt-portlet__head-icon">
                    <i class="kt-font-primary flaticon2-line-chart"></i>
                </span>
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <a href="{{route('dashboard.promo_codes.create')}}" class="btn btn-brand btn-icon-sm">
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/promo_codes.js')}}" type="text/javascript"></script>
