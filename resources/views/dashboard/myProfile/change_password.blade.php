                        ...
                        <div class="kt-widget__body">
                            ...
                            <div class="kt-widget__items">
                                <a href="{{route('dashboard.myProfile.account_info')}}" class="kt-widget__item ">
                                    ...
                                    <a href="{{route('dashboard.myProfile.change_password')}}" class="kt-widget__item kt-widget__item--active">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="col-xl-12">
                    <div class="kt-portlet">
                        <div class="kt-portlet__head">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">{{__('Change Password')}}</h3>
                            </div>
                        </div>
                        @include('layouts.parts.dashboard.errorSection')
                        <form class="kt-form kt-form--label-right" action="{{route('dashboard.myProfile.changePassword')}}" method="post">
                            @csrf
