...
@section('content')
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{route('dashboard.nationalities.update',$nationality)}}">
            @method('PUT')
            @csrf
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control @error('nationality') is-invalid @enderror"
                               type="text"
                               value="{{ old('nationality') ?? $nationality->nationality }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control @error('nationality') is-invalid @enderror"
                               type="text"
                               value="{{ old('name_english') ?? $nationality->name_english }}"
                               id="example-text-input"
                               name="name_english">
                        @error('name_english')
