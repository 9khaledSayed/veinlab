        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <a href="{{route('dashboard.nationalities.create')}}" class="btn btn-brand btn-icon-sm">
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/nationalities.js')}}" type="text/javascript"></script>
