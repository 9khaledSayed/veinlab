        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @can('view_reports')
                    <a href="/export/patients" class="btn btn-danger btn-icon-sm ml-2 mr-2">
                        <i class="la la-file-excel-o"></i> {{__('Export')}}
                    </a>
                    @endcan
                    @can('create_patients')
                    <a href="{{route('dashboard.patients.create')}}" class="btn btn-brand btn-icon-sm">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 order-1 order-xl-2 kt-align-right">
                        <a href="#" class="btn btn-default kt-hidden">
                            <i class="la la-cart-plus"></i> {{__('New Order')}}
                        </a>
