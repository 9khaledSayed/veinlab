...
@section('content')
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="post" action="{{route('dashboard.sub_analysis.update',$subAnalysis->id)}}">
            @method('PUT')
            @csrf
            <div class="kt-portlet__body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <select class="form-control kt-selectpicker @error('main_analysis_id') is-invalid @enderror"  name="main_analysis_id" data-size="7" data-live-search="true" data-show-subtext="true">
                            <option value="{{$subAnalysis->main_analysis_id}}" >{{$subAnalysis->main_analysis->general_name}} <small>{{$subAnalysis->main_analysis->abbreviated_name}}</small></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control @error('name') is-invalid @enderror" type="text" value="{{$subAnalysis->name}}" id="example-text-input" name="name">
                        @error('name')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control @error('unit') is-invalid @enderror" type="text" value="{{$subAnalysis->unit}}" id="example-text-input"  name="unit">
                        @error('unit')
