        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @can('view_reports')
                    <a href="/export/sub_analysis" class="btn btn-danger btn-icon-sm ml-2 mr-2">
                        <i class="la la-file-excel-o"></i> {{__('Export')}}
                    </a>
                    @endcan
                    @can('create_sub_analysis')
                    <a href="{{route('dashboard.sub_analysis.create')}}" class="btn btn-brand btn-icon-sm">
...
@push('scripts')
    <script src="{{asset('js/datatables/sub_analysis.js')}}" type="text/javascript"></script>
