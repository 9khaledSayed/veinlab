...
@section('content')
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @can('create_stocks')
                        <a href="{{route('dashboard.hr.memos.create')}}" class="btn btn-brand btn-icon-sm">
        ...
        <input type="text" style="display:none" value="{{Auth::guard('employee')->user()->is_master}}" id="user_type">
    </div>
@endsection
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/hr/memos.js')}}" type="text/javascript"></script>
