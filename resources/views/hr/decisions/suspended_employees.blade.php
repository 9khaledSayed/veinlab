            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        {{__('Suspended Salaries')}}
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="btn-group">
                            <a href="{{route('dashboard.hr.decisions.suspend_employee')}}" class="btn btn-danger">
...
@push('scripts')
    <script src="{{asset('js/datatables/hr/suspended_employees.js')}}" type="text/javascript"></script>
@endpush
