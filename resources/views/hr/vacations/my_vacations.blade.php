            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <a href="{{route('dashboard.hr.index')}}" class="btn btn-clean btn-icon-sm">
                        ...
                        <a href="{{route('dashboard.hr.vacation.create')}}" class="btn btn-brand btn-icon-sm">
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/hr/my_vacations.js')}}" type="text/javascript"></script>
