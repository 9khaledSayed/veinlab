        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                <h3 class="kt-portlet__head-title">
                    {{__('Employees vacations')}}
                </h3>
            </div>
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <a href="{{route('dashboard.hr.index')}}" class="btn btn-clean btn-icon-sm">
                        <i class="la la-long-arrow-left"></i>
                        {{__('Back')}}
                    </a>

                    <a href="/dashboard/hr/vacations/create" class="btn btn-brand btn-icon-sm">
                    ...
                    <div class="col-xl-10 order-2 order-xl-1">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group kt-form__group--inline">
                                    <div class="kt-form__label" >
                                        <label>{{__('Vacation Type')}}:</label>
                                    </div>
                                    <div class="kt-form__control">
                                        <select class="form-control bootstrap-select" id="kt_form_vacation">
                                            <option value="">{{__('All')}}</option>
                                            @foreach( $vacation_types as $vacation_type)
                                                <option value="{{$vacation_type->name}}">{{$vacation_type->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/hr/vacations.js')}}" type="text/javascript"></script>
