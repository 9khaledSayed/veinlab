        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{__('Salaries Types')}}</h4>
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add"
                            ...
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                                ...
                                <form action="{{route('dashboard.hr.salary_types.store')}}" method="post" class="kt-form"
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="kt-checkbox-list">
                                                                                            ...
                                                                                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                                                                                <input type="checkbox"   name="include_end_service">
                                                                                                {{__('Include End Of Service')}}
                                                                                                <span></span>
                                                                                            </label>

                                                                                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                                                                                <input type="checkbox"   name="include_salary">
                                                                                                {{__('Include Salary')}}
                                                                                                <span></span>

                                                                                            </label>
                                                                                            <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                                                                                                <input type="checkbox"   name="include_additions">
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/hr/salary_types.js')}}" type="text/javascript"></script>
