...
@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        @include('hr.additions.repeated-forms.overtime')
        @include('hr.additions.repeated-forms.general_addition')
    </div>
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" style="">
                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_3">{{__('General Additions')}}</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#kt_modal_5">{{__('Overtime')}}</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script src="{{asset('js/datatables/hr/additions.js')}}" type="text/javascript"></script>
    <script src="{{asset('js/pages/additions.js')}}" type="text/javascript"></script>
@endpush
