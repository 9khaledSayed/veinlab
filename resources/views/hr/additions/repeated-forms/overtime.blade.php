    ...
    <div class="modal-dialog modal-l" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('Add - Overtime')}}</h5>
            ...
            <div class="modal-body p-0 mx-0">
                <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                        ...
                        <form action="{{route('dashboard.hr.additions.store')}}" method="post" class="kt-form p-0" style="width: 80%" id="late_deduction">
                        @csrf
