        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <a href="{{route('dashboard.hr.memos.create')}}" class="btn btn-brand btn-icon-sm"  data-toggle="modal" data-target="#myModal">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{__('Add Branch')}}</h4>
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add"
                            ...
                            <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                                ...
                                <form action="{{route('dashboard.hr.branches.store')}}" method="post" class="kt-form"
                                                                        ...
                                                                        <div class="form-group form-group-marginless">
                                                                            ...
                                                                            <div class="form-group row mt-5 mb-5">
                                                                                ...
                                                                                <div class="col-4">
                                                                                    ...
                                                                                    <input name="license_no" class="form-control" value="" type="text" >
                                                                                    @error('license_no')
                                                                                    <div class="invalid-feedback">
                                                                                        {{$message}}
                                                                                    </div>
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/hr/branches.js')}}" type="text/javascript"></script>
