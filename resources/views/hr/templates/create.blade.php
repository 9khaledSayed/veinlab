...
@section('content')
    ...
    <div class="kt-portlet">
        ...
        <div class="kt-portlet__body">
            <form class="kt-form kt-form--label-right" method="POST" action="{{route('dashboard.hr.templates.store')}}">
                @csrf
                <div class="kt-portlet__body">
                    <div class="form-group row mt-2">
                        ...
                        <div class="col-lg-6 col-md-9 col-sm-12">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror kt-select2"
                                    ...
                                    name="type">
                                <option value=""></option>
                                <option value="12">Company Contract Draft (iqama)</option>
                            ...
                            return [
                                {
                                    ...
                                    onAction: function() {
                                        editor.insertContent(' <strong>%%company.stamp%%</strong>');
                                    }
                                },{
                                    type: 'menuitem',
