        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form action="{{route('dashboard.hr.holidays.update', $holiday)}}" method="post" class="kt-form" style="width: 80%" id="kt_contacts_add_form">
                    @csrf
                    @method('put')
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row" >
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="from_date"
                                                                           ...
                                                                           value="{{$holiday->from_date->format('Y-m-d')}}"
                                                                           readonly />
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="to_date" type="text" class="form-control datepic"
                                                                           value="{{$holiday->to_date->format('Y-m-d')}}"
                                                                           readonly />
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                                            <i class="la la-calendar"></i>
