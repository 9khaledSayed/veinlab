        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form action="{{route('dashboard.hr.vacation.store')}}" method="post" class="kt-form" id="kt_contacts_add_form">
                    @csrf
                                                        ...
                                                        <div class="kt-portlet__body">
                                                            <div class="form-group row mt-1">
                                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                                    ...
                                                                    <select class="form-control kt-selectpicker" data-val="true" name="vacation_id" id="vacation_id">
                                                                        <option value="">
                                                                            {{__('Choose')}}
                                                                        </option>
                    ...
                    <input type="number" value="{{Auth::guard('employee')->user()->id}}" style="display:none" id="employee_id">
                </div>
            </div>
        </div>
    </div>
