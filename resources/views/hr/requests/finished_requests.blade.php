                                ...
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <div class="kt-form__control">
                                        <select class="form-control bootstrap-select" id="kt_form_request">
                                            <option value="">{{__('All')}}</option>
                                            <option value="1">{{__('Salary Induction')}}</option>
                                            <option value="2">{{__('Leave')}}</option>
                                            <option value="3">{{__('Permission')}}</option>
                                            <option value="4">{{__('Trip')}}</option>
                                            <option value="5">{{__('Loan')}}</option>
                                            <option value="6">{{__('Complaint')}}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/hr/finished_requests.js')}}" type="text/javascript"></script>
