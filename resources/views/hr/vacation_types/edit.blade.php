        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form action="{{route('dashboard.hr.vacation_types.update',$vacationType->id)}}" method="post" class="kt-form" id="kt_contacts_add_form">
                    @csrf
                    @method('PUT')
                                                            ...
                                                            <div class="form-group row mt-1">
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        type="text"
                                                                        name="name"
                                                                        value="{{old('name') ?? $vacationType->name}}"
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        type="text"
                                                                        name="no_days"
                                                                        value="{{old('no_days') ?? $vacationType->no_days}}"
                                                                        id="example-text-input">
                                                                    @error('no_days')
                                                                    <div class="invalid-feedback">
                                                                        {{$message}}
