        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    @can('create_stocks')
                        <a href="{{route('dashboard.hr.vacation_types.create')}}" class="btn btn-brand btn-icon-sm">
...
@push('scripts')
    ...
    <script src="{{asset('js/datatables/hr/vacationTypes.js')}}" type="text/javascript"></script>
