                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="fname_arabic" class="form-control" type="text" disabled value="{{$employee->fname_arabic}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Middle Name Arabic')}}</label>
                                                                <input name="mname_arabic" class="form-control" type="text" disabled value="{{$employee->mname_arabic}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Last Name Arabic')}} *</label>
                                                                <input name="lname_arabic" class="form-control" type="text" disabled value="{{$employee->lname_arabic}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                                <label>{{__('First Name English')}} *</label>
                                                                <input name="fname_english" class="form-control" type="text" disabled value="{{$employee->fname_english}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Middle Name English')}}</label>
                                                                <input name="mname_english" class="form-control" type="text" disabled value="{{$employee->mname_english}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Last Name English')}} *</label>
                                                                <input name="lname_english" class="form-control" type="text" disabled value="{{$employee->lname_english}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input
                                                                        ...
                                                                        type="text"
                                                                        class="form-control"
                                                                        disabled value="{{$employee->birthdate}}"
                                                                        id="kt_datepicker_3" />
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <select name="nationality_id" disabled class="form-control kt-selectpicker" title="Choose">
                                                                    <option value="0" @if($employee->nationality_id == "0") selected @endif>{{__('Saudi')}}</option>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="kt-radio-list mx-auto text-center">
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="marital_status" value="0" disabled @if($employee->marital_status == 0) checked @endif>
                                                                        {{__('Single')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="marital_status" value="1" disabled @if($employee->marital_status == 1) checked @endif>
                                                                        {{__('Married')}}
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="kt-radio-list mx-auto text-center">
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="gender" value="0" disabled @if($employee->gender == 0) checked @endif>
                                                                        {{__('Male')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="gender" value="1" disabled @if($employee->gender == 1) checked @endif>
                                                                        {{__('Female')}}
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="kt-radio-list text-center">
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="identity_type" value="0"  disabled @if($employee->identity_type == 0) checked @endif>
                                                                        {{__('National ID')}}
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                        <input type="radio" name="identity_type" value="1"  disabled @if($employee->identity_type == 1) checked @endif>
                                                                        {{__('Iqama')}}
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="id_num" class="form-control" type="text" disabled value="{{$employee->id_num}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="id_issue_date"
                                                                           ...
                                                                           class="form-control"
                                                                           id="kt_datepicker_3"
                                                                           disabled value="{{$employee->id_issue_date}}" />
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                                            <i class="la la-calendar"></i>
                                                                        </span>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="id_expire_date"
                                                                           ...
                                                                           class="form-control"
                                                                           id="kt_datepicker_3"
                                                                           disabled value="{{$employee->id_expire_date}}"/>
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                                            <i class="la la-calendar"></i>
                                                                        </span>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input name="passport_num" class="form-control" type="text" disabled value="{{$employee->passport_num}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="passport_issue_date"
                                                                           ...
                                                                           class="form-control"
                                                                           id="kt_datepicker_3"
                                                                           disabled value="{{$employee->passport_issue_date}}"/>
                                                                    <div class="input-group-append">
                                                                    <span class="input-group-text">
                                                                        <i class="la la-calendar"></i>
                                                                    </span>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="passport_expire_date"
                                                                           ...
                                                                           class="form-control"
                                                                           id="kt_datepicker_3"
                                                                           disabled value="{{$employee->passport_expire_date}}"/>
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                                            <i class="la la-calendar"></i>
                                                                        </span>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="issue_place" class="form-control" type="text" disabled value="{{$employee->issue_place}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <input name="emp_num"
                                                                       class="form-control"
                                                                       type="text"
                                                                       disabled value="{{$employee->emp_num}}">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="joined_date"
                                                                           ...
                                                                           class="form-control"
                                                                           id="kt_datepicker_2"
                                                                           disabled value="{{$employee->joined_date}}"/>
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                                            <i class="la la-calendar"></i>
                                                                        </span>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <select name="role_id" class="form-control kt-selectpicker" title="Choose" disabled>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <select name="branch_id" class="form-control kt-selectpicker" title="Choose" disabled>
                                                                    @forelse($branches as $branch)
                                                                        <option value="{{$branch->id}}"
                                                                                @if($branch->id == $employee->branch_id) selected @endif
                                                                        >{{$branch->name}}</option>
                                                                    @empty
                                                            ...
                                                            <div class="col-12 mt-3">
                                                                ...
                                                                <select name="shift_type" class="form-control kt-selectpicker" title="Choose"  disabled>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <select name="contract_type" class="form-control kt-selectpicker" title="Choose" disabled>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="start_date" type="text" class="form-control" id="kt_datepicker_3" disabled value="{{$employee->start_date}}"/>
                                                                    <div class="input-group-append">
                                                                    <span class="input-group-text">
                                                                        <i class="la la-calendar"></i>
                                                                    </span>
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <input name="contract_period" class="form-control" type="text" disabled value="{{$employee->contract_period}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input name="basic_salary" class="form-control" type="text" disabled value="{{$employee->basic_salary}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                                    ...
                                                                    <div class="kt-checkbox-list">
                                                                        @foreach($allowances as $allowance)
                                                                            <label class="kt-checkbox kt-checkbox--bold  @if($allowance->type == 1) kt-checkbox--success @else kt-checkbox--danger @endif ">
                                                                                <input name="allowance[]" disabled checked value="{{$allowance->id}}" type="checkbox">
                                                                                {{$allowance->name}}

                                                                                @if($allowance->value)
                                                                                    ( {{$allowance->value . __('Ryal')}} )
                                                                                @else
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <input name="phone" class="form-control" type="text" disabled value="{{$employee->phone}}">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <label>{{__('Email')}} *</label>
                                                                <input name="email" class="form-control" type="text" disabled value="{{$employee->email}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
