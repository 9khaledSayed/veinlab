        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                    ...
                    <form action="{{route('dashboard.hr.employees.update', $employee)}}" method="post" class="kt-form" style="width: 65%" id="kt_contacts_add_form">
                    @csrf
                    @method('put')
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input name="fname_arabic" class="form-control" type="text"  value="{{$employee->fname_arabic}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Middle Name Arabic')}}</label>
                                                                <input name="mname_arabic" class="form-control" type="text"  value="{{$employee->mname_arabic}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Last Name Arabic')}} *</label>
                                                                <input name="lname_arabic" class="form-control" type="text"  value="{{$employee->lname_arabic}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-4">
                                                                <label>{{__('First Name English')}} *</label>
                                                                <input name="fname_english" class="form-control" type="text"  value="{{$employee->fname_english}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Middle Name English')}}</label>
                                                                <input name="mname_english" class="form-control" type="text"  value="{{$employee->mname_english}}">
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <label>{{__('Last Name English')}} *</label>
                                                                <input name="lname_english" class="form-control" type="text"  value="{{$employee->lname_english}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="input-group date">
                                                                    <input name="start_date" type="text" class="form-control datepicker" readonly value="{{$employee->start_date->format('Y-m-d')}}"/>
                                                                    <div class="input-group-append">
                                                                    <span class="input-group-text">
                                                                        <i class="la la-calendar"></i>
                                                                    </span>
                                                    ...
                                                    <div class="kt-section__body">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <input name="basic_salary" class="form-control" type="text"  value="{{$employee->basic_salary}}">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                                    ...
                                                                    <div class="kt-checkbox-list">
                                                                        @foreach($allowances as $allowance)
                                                                            ...
                                                                            <label class="kt-checkbox kt-checkbox--bold  @if($allowance->type == 1) kt-checkbox--success @else kt-checkbox--danger @endif ">
                                                                                <input name="allowance[]" @if($employee->allowance_types->contains($allowance)) checked @endif value="{{$allowance->id}}" type="checkbox">
                                                                                {{$allowance->name}}
