            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                    @foreach($my_attendance as $attendance)
                        {
                            title: '{{__('Time In')}} : {{\Carbon\Carbon::createFromFormat("H:i:s",$attendance->time_in)->format("h:iA")}}',
                    ...
                    @if(isset($attendance->time_out))
                        {
                            title: '{{__('Time Out')}} : {{\Carbon\Carbon::createFromFormat("H:i:s",$attendance->time_out)->format("h:iA")}}',
                            start: '{{$attendance->created_at->format('Y-m-d')}}',
