    ...
    <div class="modal-dialog modal-l" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('General Deduction')}}</h5>
            ...
            <div class="modal-body p-0 mx-0">
                <div class="kt-grid  kt-wizard-v1 kt-wizard-v1--white droid_font" id="kt_contacts_add" data-ktwizard-state="step-first">
                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                        ...
                        <form action="{{route('dashboard.hr.deductions.store')}}" method="post" class="kt-form p-0" style="width: 80%" id="general_deduction">
                        @csrf
                                                ...
                                                <div class="kt-section__body">
                                                    <div class="kt-section">
                                                        <div class="kt-section__body">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-lg-6">
                                                                    <label>{{__('Deduction Reason')}} *</label>
