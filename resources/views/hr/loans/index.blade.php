...
@section('content')
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        @include('hr.loans.repeated-forms.create')
    </div>
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#kt_loans_1">
...
@push('scripts')
    <script src="{{asset('js/pages/loans.js')}}" type="text/javascript"></script>
    <script src="{{asset('js/datatables/hr/loans.js')}}" type="text/javascript"></script>
@endpush
