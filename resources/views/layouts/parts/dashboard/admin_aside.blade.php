        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav" >
                ...
                @canany(['view_roles', 'show_roles', 'create_roles', 'update_roles', 'delete_roles'])
                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon  fas fa-unlock-alt"></i><span class="kt-menu__link-text">{{__('Roles')}}</span><i class="kt-menu__ver-arrow la la-angle-right" ></i></a>
                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                            <ul class="kt-menu__subnav">
                                ...
                                @endcan
                                @can('create_roles')
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{route('dashboard.roles.assigned_employees')}}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">{{__('Assign Role')}}</span></a></li>
                                @endcan
                            </ul>
                        </div>
                    </li>
                @endcan
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon  fas fa-desktop"></i><span class="kt-menu__link-text">{{__('Reception')}}</span><i class="kt-menu__ver-arrow la la-angle-right" ></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            @canany(['view_packages', 'show_packages', 'create_packages', 'update_packages', 'delete_packages'])
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="{{route('dashboard.packages.index')}}" class="kt-menu__link">
                                        <i class="kt-menu__link-icon  fas fa-boxes"></i>
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon  fa fa-user-nurse"></i><span class="kt-menu__link-text">{{__('Transfer Destination')}}</span><i class="kt-menu__ver-arrow la la-angle-right" ></i></a>
                        <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                            <ul class="kt-menu__subnav">
                                ...
                                @endcan
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="{{route('dashboard.sectors.index')}}" class="kt-menu__link">
                                        <i class="kt-menu__link-icon  flaticon2-delivery-package"></i>
                                        <span class="kt-menu__link-text">{{__('Sectors')}}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon  fas fa-flask"></i><span class="kt-menu__link-text">{{__('Lab')}}</span><i class="kt-menu__ver-arrow la la-angle-right" ></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon  fas fa-coins"></i><span class="kt-menu__link-text">{{__('Accountant')}}</span><i class="kt-menu__ver-arrow la la-angle-right" ></i></a>
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            @can('view_exports')
                            ...
                            @canany(['view_stocks', 'show_stocks', 'create_stocks', 'update_stocks', 'delete_stocks'])
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="{{route('dashboard.stock.index')}}" class="kt-menu__link ">
                                        ...
                                        <span class="kt-menu__link-text">{{__('Stock')}}</span>
                                    </a>
                                </li>
                            @endcan
